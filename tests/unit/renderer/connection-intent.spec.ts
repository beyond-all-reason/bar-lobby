...
const simulateBattleEnded = () => battleEndedHandlers.forEach((handler) => handler({ battleId: "battle-1", players: [], bots: [], spectators: [], winningAllyTeamIds: [] } satisfies BattleEndedEventData));
