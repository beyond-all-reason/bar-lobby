...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/play/customLobbies/customLobbies': RouteRecordInfo<'/play/customLobbies/customLobbies', '/play/customLobbies/customLobbies', Record<never, never>, Record<never, never>>,
    '/play/customLobbies/lobby': RouteRecordInfo<'/play/customLobbies/lobby', '/play/customLobbies/lobby', Record<never, never>, Record<never, never>>,
