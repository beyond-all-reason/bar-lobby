...
export const usePrompt = () => {
    const promptRef = shallowRef<Prompt<any>>();
    function prompt<C extends DefineComponent<any, any, any, any, any>>(options: PromptOptions<C>): Promise<ReturnType<C> | undefined> {
