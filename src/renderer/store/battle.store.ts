...
import { Battle, BattleWithMetadata, Bot, Faction, GameMode, isBot, isPlayer, isRaptor, isScavenger, isScavengerOrRaptor, Player, StartPosType, Team } from "@main/game/battle/battle-types";
