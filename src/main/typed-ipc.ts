...
export type IPCCommands = {
    ...
    "game:getLatestTestVersion": () => GameVersion | undefined;
    ...
    "game:launchChobby": (settings: ChobbyLaunchSettings) => void;
    ...
    "maps:online:fetchMapImages": (imageSource: string) => ArrayBuffer | undefined;
