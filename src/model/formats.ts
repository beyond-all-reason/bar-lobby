...
export function isEngineVersionString(version: string): boolean {
    return engineVersionFormatRegex.test(version);
}
export function parseEngineVersionString(engineVersionString: string): EngineVersion {
 ...
 * */
export function gitEngineTagToEngineVersionString(gitEngineTag: string): string {
